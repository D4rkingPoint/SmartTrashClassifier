...
WEIGHTS_PATH = "runs/Entrenamiento_yolov8/train3/weights/best.pt"  # Ajusta aquí

SAVE_DIR = "evaluate_yolov8"
...
for img_id in tqdm(coco.getImgIds(), desc="Inferencia YOLOv8"):
    ...
    # Inferencia (puedes ajustar conf y iou si quieres)
    preds = model(img)[0]
...
pred_path = os.path.join(SAVE_DIR, "yolov8_predictions.json")
...
df = pd.DataFrame([["YOLOv8", ap50, precision, recall, f1]],
